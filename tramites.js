...
(function() {
  ...
  function updateJournalMeta(key, metaEl) {
    ...
    metaEl.textContent = 'Última edición: ' + String(d.getDate()).padStart(2,'0') + '/' + String(d.getMonth()+1).padStart(2,'0') + '/' + String(d.getFullYear()).slice(2) + ' ' + d.toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit' });
  }
